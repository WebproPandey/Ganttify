...
const Home = () => {
  return (
    <div className="Home h-[740px] w-full flex p-[104px] gap-[30px]">
    <div className="rightside h-full w-full  rotate-180 relative">
      <div className=" h-full w-full relative ">
        ...
        <div className="bg-[#F6F8FA] h-[217px] w-[175px] flex flex-col  justify-evenly items-center  absolute top-[100px] left-[20px] rounded-[12px] ">
          <div className="topreactanlge  h-[86px] w-[143px] relative   bg-white rounded-[8px]">
            ...
            <div className="viewers flex justify-between items-center gap-16 absolute top-[60px] left-[8px] ">
          ...
          <div className="bottomreactanlge  h-[86px] w-[143px]   bg-white rounded-[8px] relative">
          <div className="img h-[20px] w-[20px] absolute top-[8px] left-[8px]">
            ...
            <div className="viewers flex justify-between items-center gap-12 absolute top-[60px] left-[8px] ">
        ...
        <div className="absolute bg-white bottom-[30px] left-1/2 -translate-x-1/2 flex flex-col gap-2 justify-evenly items-center rounded-xl p-6 w-[350px] h-[140px]">
           <div className="smallCircle  flex  gap-1 items-center absolute  top-2 left-2  h-[12px] w-[100px]">
             <div className="redcircle h-[12px] w-[12px]  bg-red-500 rounded-full"></div>
             <div className="yellowcircle h-[12px] w-[12px]  bg-yellow-500 rounded-full"></div>
             <div className="greencircle h-[12px] w-[12px]  bg-green-500 rounded-full"></div>
           </div>
          <div className="top h-[44px] w-[326px]  px-2 flex justify-between items-center  rounded-[8px] bg-[#f9f9fa]">
            <h1 className="text-[12px] font-[600] text-[#061a2a]">🚀 User newly onboarded</h1>
            <h1 className="text-[12px] text-[#828c95] font-[400]">2 days ago</h1>
          </div>
          <div className="bottom h-[44px] w-[326px]  px-2 flex justify-between items-center  rounded-[8px] bg-[#f9f9fa]">
            <h1 className="text-[12px] font-[400] text-[#828c95]">💰 Made and purchase</h1>
            <h1 className="text-[12px] text-[#828c95] font-[400]">5 days ago</h1>
          </div>              
        </div>
      </div>
    </div>
    <div className="leftside h-[532px] w-full   rotate-180 flex flex-col gap-[40px] ">
      <div className="content h-[350px] w-full flex flex-col gap-[16px]  ">
        <div className="contentwrapper h-full w-full">
          <div className="inline-flex gap-2 items-center bg-white/10  rounded-full h-[32px] w-[156px] pt-[8px] pl-[8px] pb-[8px] pr-[12px]">
            <img src={crossicon} alt="" className="h-[20px] w-[20px]" />
            <span className="text-[#ffffff] font-[500] text-[12px]">
              Goals & Reporting
            </span>
          </div>
          <div className="heading h-[160px] ">
            <h1 className="text-[60px] text-[#ffffff] font-[600] tracking-tighter leading-[80px]">
              Goals and Reporting In One Place
            </h1>
          </div>
          <div className="distription h-[54px] w-full">
            <p className="text-gray-400 text-[18px]  max-w-[80%]">
              Connect every team's work to company objectives, then track
              progress with real-time data
            </p>
          </div>
        </div>
        <div className="action h-[52px] flex  gap-[16px]">
      ...
      <div className="Social-proof h-[82px] ">
        <p className="text-[14px] text-[#ffffff]  mb-4">
