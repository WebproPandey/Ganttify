...
const Contact = () => {
  return (
    <div className="contact  h-[782px] w-full flex justify-center items-start p-[104px] gap-[80px]">
      <div className="headingwraper h-[209px] w-1/2   py-[8px]  flex flex-col gap-[20px] " >
       <div className="logo">
      ...
      <div className="max-w-lg mx-auto p-8 bg-white shadow-lg rounded-[28px]">
       <form className="space-y-6">
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700">Problem Descriptions</label>
          <textarea
            placeholder="Message"
            rows="4"
