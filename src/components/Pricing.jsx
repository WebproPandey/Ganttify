...
const Pricing = () => {
  return (
    <div className="pricing h-[989px] w-full flex flex-col  justify-center  items-center gap-[80px] p-[104px] ">
      <div className="headingwraper h-[188px] w-full  flex flex-col gap-[20px]">
        <div className="logo">
        ...
        <div className="headingwraper h-[140px] w-full flex justify-between  items-end">
          <div className="heading w-[50%] ">
            <h1 className="text-[56px] font-[600] leading-[70px] text-[#ffffff] tracking-tighter">
              Simple and Flexible Pricing
            </h1>
          </div>
          <div className="buttonbar w-[226px] h-[61px] px-[7px] bg-[#3f3f3f4f]  rounded-[8px] flex items-center justify-between">
            <button className="button h-[38px] w-[121px] p-[8px] rounded-[8px] bg-[#ffffff] font-[500] text-[14px] text-[#000000] flex items-center justify-center">
              Monthly
            </button>
            <button className="button h-[38px] w-[121px] p-[8px] rounded-[8px] font-[500] text-[14px] text-[#ffffff] bg-transparent flex items-center justify-center">
              Annually
            </button>
          </div>
        </div>
      </div>
      <div className="pricingcart h-[513px] w-full flex gap-[24px] justify-center items-center ">
        <div className="cartitem bg-[#ffffff]/10 rounded-[24px]  w-full h-[513px] flex flex-col gap-[24px] p-[24px]">
          ...
          <div className="Aboutplan w-full ">
            <div className="rounded-xl flex flex-col gap-[24px] shadow-lg text-white">
              <h3 className="text-[16px] font-[600] leading-[24px] text-white">
                This Plan Includes:
              </h3>
              <ul className="space-y-3">
                ...
                <li className="flex items-center space-x-3">
                  ...
                  <span className="text-sm text-[#ffffff50]">Bulk emailing</span>
                </li>
                <li className="flex items-center space-x-3">
                  <span className="h-4 w-4 rounded-full bg-[#ffffff80] flex items-center justify-center">
                    <svg
                  ...
                  <span className="text-sm text-[#ffffff50]">AI Integration</span>
                </li>
                <li className="flex items-center space-x-3">
                  <span className="h-4 w-4 rounded-full bg-[#ffffff80] flex items-center justify-center">
                    <svg
                  ...
                  <span className="text-sm text-[#ffffff50]">
        ...
        <div className="cartitem bg-[#ffffff] rounded-[24px]  w-full h-[513px] flex flex-col gap-[24px] p-[24px]">
          <div className="header h-[137px] w-full ">
            ...
            <div className="rounded-xl flex flex-col gap-[24px] shadow-lg text-white">
              ...
              <ul className="space-y-3">
                <li className="flex items-center space-x-3">
                  ...
                  <span className="text-[#666D80] text-[16px] font-[400]">
                    Email sequences  
                  </span>
                </li>
                <li className="flex items-center space-x-3">
                  ...
                  <span className="text-sm text-[#666D80]">Send emails from multiple domains</span>
                </li>
                <li className="flex items-center space-x-3">
                  <span className="h-4 w-4 rounded-full bg-[#31313112] flex items-center justify-center">
                    <svg
                  ...
                  <span className="text-sm text-[#666D80]">Connect multiple email accounts</span>
                </li>
                <li className="flex items-center space-x-3">
                  <span className="h-4 w-4 rounded-full bg-[#31313112] flex items-center justify-center">
                    <svg
            ...
            <div className="rounded-xl flex flex-col gap-[24px] shadow-lg text-white">
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-center space-x-3">
                  ...
                  <span className="text-sm text-[#ffffff50]">Custom billing</span>
                </li>
                <li className="flex items-center space-x-3">
                  <span className="h-4 w-4 rounded-full bg-[#ffffff80] flex items-center justify-center">
                    <svg
                  ...
                  <span className="text-sm text-[#ffffff50]">Dedicated slack channel</span>
                </li>
                <li className="flex items-center space-x-3">
                  <span className="h-4 w-4 rounded-full bg-[#ffffff80] flex items-center justify-center">
                    <svg
